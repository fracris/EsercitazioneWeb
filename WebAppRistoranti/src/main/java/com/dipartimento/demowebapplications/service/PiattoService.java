...
//    private  PiattoDao dao;
    ...
    private void checkPiattoIsValid(Piatto piatto) throws PiattoNotValidException {
        ...
        if (piatto.getIngredienti() == null || piatto.getIngredienti().isEmpty()) {
            throw new PiattoNotValidException("Piatto.ingredienti must be not null and contain at least one ingredient");
        }
    }
    ...
    public Piatto updatePiatto(String nomePiatto, Piatto piatto) throws Exception {
        ...
        if(byPrimaryKey==null){
            throw new Exception("Not exists a Piatto with the name:"+piatto.getNome());
        }
    ...
    public void deletePiatto(String nome) throws Exception {
        Piatto byPrimaryKey = piattoDao.findByPrimaryKey(nome);
        if(byPrimaryKey==null){
            throw new Exception("Not exists a Piatto with the name:"+nome);
        }
        this.piattoDao.delete(byPrimaryKey);
    }
}